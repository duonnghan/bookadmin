            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 ">
                        <div class="white-box">
                            <h3 class="box-title">Danh sách các tác giả</h3>
                            ...
                            function tableData(){
                                $('#tabledit').Tabledit({
                                    ...
                                    columns: {
                                        identifier: [0, 'id'],
                                        editable: [[1, 'name'],[2, 'address'],[3, 'bio']]
                                    },
                            ...
                            <div>
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="name" placeholder="Họ tên tác giả" class="form-control form-control-line"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Địa chỉ</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Địa chỉ" class="form-control form-control-line" id="address"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Tiểu sử</label>
                                        <div class="col-md-12">
                                            <textarea rows="7" id="bio" placeholder="Tiểu sử tác giả..." class="form-control form-control-line"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name="addauthor" type="Submit" onclick="addAuthor()" value="add" class="btn btn-success">Thêm</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
